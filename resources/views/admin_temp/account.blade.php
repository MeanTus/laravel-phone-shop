...
<form class="form-header" action="/acc-search" method="GET">
    ...
    <input type="hidden" name="tk" value="user">
...
<br>
	<div class="table-data__tool">
        <div class="table-data__tool-right">
            <a style='color: white' href='/add-account'><button class="au-btn au-btn-icon au-btn--green au-btn--small">
                <i class="zmdi zmdi-plus"></i>Thêm tài khoản mới</button></a>
        </div>
    </div>
